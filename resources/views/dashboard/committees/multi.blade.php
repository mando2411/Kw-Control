...
@section('content')
    <form action="{{ route('dashboard.committees.multi' ) }}" method="POST" class="page-body">
        @csrf
        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        <x-dashboard.form.input-text error-key="number" name="men"  id="number" label-title="عدد اللجان رجال"/>
                        <x-dashboard.form.input-text error-key="number" name="women"  id="number" label-title="عدد اللجان نساء"/>
