    ...
    <section class="pb-5 pt-2 rtl">
        <div class="container">
            ...
            <div class="flex-grow-1 ms-2">
                <button data-bs-toggle="modal" data-bs-target="#smExportModal" id="smOpenExportFromCommittee" class="btn btn-info w-100">استخراج
                    كشوف</button>
            </div>
...
@push('js')
    ...
    <script>
        $(document)
            .off('click.committeeVoterData', 'i[data-bs-target="#voterData"]')
            .on('click.committeeVoterData', 'i[data-bs-target="#voterData"]', function () {
    ...
    <script>
        (function () {
            const openExportBtn = document.getElementById('smOpenExportFromCommittee');
