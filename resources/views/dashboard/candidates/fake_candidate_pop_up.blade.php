            ...
            <div class="modal-dialog modal-dialog-centered">
                <div class="modal-content">
                    <div class="modal-header bg-light">
                        ...
                        <h5 class="modal-title" id="confirmModalLabel" style="color:black">اضافه مرشح وهمى </h5>
                    </div>
                    <div class="modal-body text-center py-4" style="direction: rtl;">
                        ...
                        <input placeholder="اسم المرشح" type="text" id="name" name="name" class="form-control" ><br>
                        ...
                        <input type="file" id="image" name="image" class="form-control" accept="image/*"><br>
                        <input type="hidden" id="fake" name="fake" value="1">
